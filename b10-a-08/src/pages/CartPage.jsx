  ...
  return (
    <div className={`container mx-auto p-6 ${isRedirecting ? "fade-out" : ""}`}>
      ...
      <div className="flex justify-between mb-4">
        <p className="mx-auto mr-80 text-xl font-bold">
          Total Cost: ${sortedCart.reduce((total, item) => total + item.price, 0)}
        </p>
      ...
      {sortedCart.length === 0 ? (
        ...
        <div className="flex flex-col gap-4">
          {sortedCart.map((item) => (
            <div
              key={item.cartId}
              className="bg-white p-4 rounded-md shadow-md flex items-center card-item"
            >
              <img
